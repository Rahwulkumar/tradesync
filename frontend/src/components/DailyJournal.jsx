  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-950 to-black p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {/* Summary Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 pb-6 border-b border-white/5">
          <GlassCard variant="medium" hoverable={true}>
            <div className="p-6 border-l-2 border-white/5">
              <div className="flex items-center justify-between mb-2">
                <span className="text-white/70 text-sm font-medium">Daily P&L</span>
          ...
          <GlassCard variant="medium" hoverable={true}>
            <div className="p-6 border-l-2 border-white/5">
              ...
              <div className={`text-3xl font-bold ${
                summary.averageR > 1 ? 'text-emerald-400' : 'text-amber-400'
              }`}>
                {summary.averageR > 0 ? '+' : ''}
          ...
          <GlassCard variant="medium" hoverable={true}>
            <div className="p-6 border-l-2 border-white/5">
              <div className="flex items-center justify-between mb-2">
                <span className="text-white/70 text-sm font-medium">Trading Hours</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pb-6 border-b border-white/5">
            ...
            <GlassCard variant="medium" hoverable={false}>
              <div className="p-6 border-t-2 border-white/5">
                <div className="flex items-center justify-between mb-6 pb-3 border-b border-white/5">
                  <div>
                    <h3 className="text-lg font-bold text-white">Today's Trades</h3>
                    <p className="text-white/60 text-sm">{todaysTrades.length} executions</p>
                  </div>
                ...
                {todaysTrades.length > 0 ? (
                  <div className="space-y-4">
                    {todaysTrades.map((trade) => (
                      <div key={trade.id} className="p-4 rounded-lg bg-white/5 hover:bg-white/10 transition-colors border border-white/5">
                        ...
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <div className="text-right">
                            <div className={`text-lg font-bold ${
                              calculatePnL(trade) > 0 ? 'text-emerald-400' : 'text-red-400'
                            }`}>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm border-t border-white/5 pt-3">
                          <div>
                ...
                <div className="p-6 border-r border-white/5">
                  <div className="flex items-center justify-between mb-6 pb-3 border-b border-white/5">
                    <div>
                      ...
                      <p className="text-white/60 text-sm">Pre-trade emotional state</p>
                    </div>
                ...
                <div className="p-6 border-l border-white/5">
                  <div className="flex items-center justify-between mb-6 pb-3 border-b border-white/5">
                    <div>
                      ...
                      <p className="text-white/60 text-sm">Trading skill assessment</p>
                    </div>
          ...
          <div className="space-y-6">
              ...
              <div className="p-6 border-t-2 border-white/5">
                <div className="flex items-center justify-between mb-6 pb-3 border-b border-white/5">
                  <div>
                    ...
                    <p className="text-white/60 text-sm">Insights and analysis</p>
                  </div>
            ...
            <GlassCard variant="medium" hoverable={false}>
              <div className="p-6 border-t-2 border-white/5">
                <div className="flex items-center justify-between mb-6 pb-3 border-b border-white/5">
                  <div>
                    <h3 className="text-lg font-bold text-white">Learning & Growth</h3>
                    <p className="text-white/60 text-sm">Continuous improvement</p>
                  </div>
                ...
                {editableJournal.bestSetup && (
                  <div className="p-3 rounded-lg bg-gradient-to-r from-emerald-500/10 to-emerald-600/10 border border-emerald-500/20">
                    <div className="flex items-center justify-between">
